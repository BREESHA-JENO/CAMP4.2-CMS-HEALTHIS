...
class PharmacistDaoImpl(AbstractPharmacistDao):
    ...
    # ---------- MEDICINES ----------
    def add_medicine_from_stock(self, medicine_id: str, medicine_name: str, quantity: int, price: float):
        try:
            with self.conn.cursor() as cur:
                # Check stock exists
                ...
                cur.execute("INSERT INTO medicines (medicine_id, medicine_name, price, expiry_date) "
                            "SELECT medicine_id, medicine_name, %s, expiry_date "
